...
class SaveSellerMobileRequest
{
	...
	*/
	...
	public function handle($request, Closure $next)
	{
		...
		$data['client_id'] = (isset($user)) ? $user->seller_id : 0;
		$data['app_source'] = "seller";
		$data['body'] = $body;
		$data['fname'] = $method;
...
public function getUserIdParam($data){
	...
	else if(isset($data['seller_id'])){
	  return $this->clean_sqlwords($data['seller_id']);
	}
