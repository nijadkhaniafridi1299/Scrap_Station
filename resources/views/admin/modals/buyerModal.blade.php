    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Are You Sure Verify this?</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary confirm_btn"  id="rowcheck-{{$buyer->buyer_id}}" onclick="Buyer_verified(this)">Yes</button>
            </div>
        </div>
    </div>
  </div> 
            ...
            <div class="invoice-preview-card card">
                <div class="invoice-padding pb-0 card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                          ...
                          <tbody>
                              <tr>
                                  ...
                                  <i class="bi bi-plus-circle-fill adding_recharges set_id" style="margin-left:1%;" id="" title="Add Recharge"></i>                                  </td>
                      ...
                      <tbody>
                          <tr>
                            <td class="toggleClass" id="icon_model-{{ $buyer->buyer_id }}">
                              {{-- <label class="switch">
                              <input type="checkbox" class="statechange" value="{{ $buyers->is_verified }}" id="modalcheck-{{$buyers->buyer_id}}"  onchange="checkboxChange(this)" {{ $buyers->is_verified==1 ? 'checked' : '' }} class="getvalue">
